...
('Inception', 'A thief who steals corporate secrets through dream-sharing technology is given the inverse task of planting an idea into the mind of a CEO.', 'Sci-Fi', 148, 'Christopher Nolan', 'Leonardo DiCaprio, Joseph Gordon-Levitt, Ellen Page, Tom Hardy', 'PG-13', 2010, '/images/posters/2.jpg', 'https://www.youtube.com/embed/YoHD2QEP4NQ', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('The Shawshank Redemption', 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', 'Drama', 142, 'Frank Darabont', 'Tim Robbins, Morgan Freeman, Bob Gunton', 'R', 1994, '/images/posters/7.jpg', 'https://www.youtube.com/embed/6hN7dIFe0ys', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Pulp Fiction', 'The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.', 'Crime', 154, 'Quentin Tarantino', 'John Travolta, Uma Thurman, Samuel L. Jackson, Harvey Keitel', 'R', 1994, '/images/posters/8.jpg', 'https://www.youtube.com/embed/s7EdQ4FqJgs', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('The Godfather', 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son Michael.', 'Crime', 175, 'Francis Ford Coppola', 'Marlon Brando, Al Pacino, James Caan, Robert Duvall', 'R', 1972, '/images/posters/9.jpg', 'https://www.youtube.com/embed/UaVTIH8mE6g', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Forrest Gump', 'The presidencies of Kennedy and Johnson, the Vietnam War, and the Watergate scandal unfold from the perspective of an Alabama man with an IQ of 75.', 'Drama', 142, 'Robert Zemeckis', 'Tom Hanks, Sally Field, Gary Sinise, Mykelti Williamson', 'PG-13', 1994, '/images/posters/10.jpg', 'https://www.youtube.com/embed/bLvqoByUGDU', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('The Avengers', 'Earth''s mightiest heroes must come together and learn to fight as a team to save the world from an alien threat.', 'Action', 143, 'Joss Whedon', 'Robert Downey Jr., Chris Evans, Chris Hemsworth, Scarlett Johansson', 'PG-13', 2012, '/images/posters/11.jpg', 'https://www.youtube.com/embed/eOrNdBpgMrY', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Titanic', 'A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.', 'Romance', 194, 'James Cameron', 'Leonardo DiCaprio, Kate Winslet, Billy Zane, Kathy Bates', 'PG-13', 1997, '/images/posters/12.jpg', 'https://www.youtube.com/embed/CHYkxuD6ekw', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('The Lion King', 'A young lion prince flees his kingdom only to learn the truth about his father''s death and take his rightful place in the Circle of Life.', 'Animation', 88, 'Roger Allers, Rob Minkoff', 'James Earl Jones, Jeremy Irons, Matthew Broderick, Whoopi Goldberg', 'G', 1994, '/images/posters/13.jpg', 'https://www.youtube.com/embed/jqSLOunknKQ', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Gladiator', 'A former Roman General sets out to exact vengeance against the corrupt emperor who murdered his family and sent him into slavery.', 'Action', 155, 'Ridley Scott', 'Russell Crowe, Joaquin Phoenix, Lucilla, Djimon Hounsou', 'R', 2000, '/images/posters/14.jpg', 'https://www.youtube.com/embed/owK1qxDselE', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Jurassic Park', 'A pragmatic paleontologist touring an almost complete theme park is tasked with protecting a couple of kids and dinosaurs when a power failure causes the park''s cloned dinosaurs to run amok.', 'Sci-Fi', 127, 'Steven Spielberg', 'Sam Neill, Laura Dern, Jeff Goldblum, Richard Attenborough', 'PG-13', 1993, '/images/posters/15.jpg', 'https://www.youtube.com/embed/QWBKEmWWL38', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('The Silence of the Lambs', 'A young FBI cadet must receive the help of an incarcerated and manipulative cannibal killer to help catch another serial killer who skins his female victims.', 'Thriller', 118, 'Jonathan Demme', 'Jodie Foster, Scott Glenn, Anthony Hopkins', 'R', 1991, '/images/posters/16.jpg', 'https://www.youtube.com/embed/W5JHoLWTcr0', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
